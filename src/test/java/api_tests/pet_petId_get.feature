...
Scenario: Get pet by ID
  ...
  When method get
  Then status 200
  And match response contains { id: '#number', category: '#object', name: '#string', photoUrls: '#array', tags: '#array', status: '#string' }
  And match response == { id: '#(petId)', name: 'doggie', photoUrls: '#array', tags: '#array', status: '#string' }
