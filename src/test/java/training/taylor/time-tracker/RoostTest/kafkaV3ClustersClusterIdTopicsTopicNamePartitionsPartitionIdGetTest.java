...
public class kafkaV3ClustersClusterIdTopicsTopicNamePartitionsPartitionIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/training/taylor/time-tracker/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_name_partitions_partition_idGetTest.csv", envVarsList);
    }
